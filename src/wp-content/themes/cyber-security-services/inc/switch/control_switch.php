 ...
 * Control - Switch.
 *
 * @package Cyber Security Services Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Cyber_Security_Services_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'cyber-security-services-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'cyber-security-services-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
