...
>
	...
	<?php
		...
		printf( esc_html__( 'Comments on &#39;%1$s&#39; (%2$s)', 'dw-medieval' ), wp_kses_post( get_the_title() ), esc_html( get_comments_number() ) );
	?>
	</h2>
	...
	paginate_comments_links(
		array(
			'prev_text' => '&#171; ' . _x( 'Older comments', 'link', 'dw-medieval' ),
			'next_text' => _x( 'Newer comments', 'link', 'dw-medieval' ) . ' &#187;',
		)
	);
	?>
</div>
